...
export function Inject<T>(name: Name<T>, immediatelyResolver: (instance: T) => any): PropertyDecorator
export function Inject<T>(name: Name<T>, params: InjectParams<T>): PropertyDecorator
